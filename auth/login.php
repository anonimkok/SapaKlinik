    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8 animate-fade-in">
            <a href="../index.php" class="inline-flex items-center space-x-3">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-primary to-emerald-700 flex items-center justify-center" style="box-shadow: 0 0 30px rgba(16, 185, 129, 0.3);">
        ...
        <!-- Login Card -->
        <div class="glass-card rounded-2xl p-8 animate-fade-in animate-delay-1">
            <div class="mb-6">
                <h1 class="font-display font-semibold text-2xl mb-2">Selamat Datang</h1>
                <p class="text-text-secondary text-sm font-mono">Masuk ke akun anda untuk melanjutkan</p>
            </div>
        ...
        <!-- Admin Info -->
        <div class="mt-4 text-center animate-fade-in animate-delay-2">
            <p class="text-text-secondary/40 text-xs font-mono">Demo Admin: admin@sapaklinik.com / admin123</p>
        </div>
    </div>
</div>
